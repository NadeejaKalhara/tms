...
sts:stsm
     ...
     const Toast = Swal.mixin({
      ...
      telenot(classname+ " is now accessable only by paid students" +"\n<b>Tutor Name:</b> "+localStorage.getItem("nm")+"\n<b>Class ID: </b>"+cid)
      Toast.fire({
        icon: 'success',
...
sts:stsm
     ...
     const Toast = Swal.mixin({
      ...
      telenot(classname+ " is now now in Auto Access mode" +"\n<b>Tutor Name:</b> "+localStorage.getItem("nm")+"\n<b>Class ID: </b>"+cid)
      Toast.fire({
        icon: 'success',
...
sts:"open"
     ...
     const Toast = Swal.mixin({
      ...
      telenot(classname+ " is now open for every student." +"\n<b>Tutor Name:</b> "+localStorage.getItem("nm")+"\n<b>Class ID: </b>"+cid)
